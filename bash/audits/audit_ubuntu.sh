...
# Example: Check if UFW (Uncomplicated Firewall) is enabled
check_configuration "UFW (Uncomplicated Firewall) Status" "ufw status | grep 'Status: active'" "Status: active"
